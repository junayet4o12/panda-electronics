            ...
            <div>
                <div className={`${!brandname && 'hidden'}`}>
                    <div className="pt-20 max-w-7xl mx-auto">
                        <h2 className={`text-3xl font-bold text-center py-7 ${theme ? 'text-black' : 'text-white'}`}>{product.name} Details</h2>
