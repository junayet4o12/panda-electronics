    ...
    return (
        <div className="max-w-7xl mx-auto py-20">
            <div className="p-4 sm:pl-10">
                <h2 className="text-4xl font-bold text-gray-600 text-center">CONTACT US</h2>
       ...
       <div className="text-center">
        <button className="btn rounded-lg bg-purple-600 hover:bg-purple-700  text-white font-bold text-sm">send email</button>
       </div>
        </div>
    );
};
